 ...
 *
 * 起因：系統擁有者看到自己日曆上寫「台灣房屋三重國小捷運店預約｜陳大明」——「好奇怪的名詞」。
...
/**
 * 沒設定時的標題。
 * 2026-09-09 加上電話：手機日曆只看得到標題那一行，把電話放進去，
 * 出門前掃一眼日曆就能直接撥，不用點進去看說明欄。
 */
export const DEFAULT_CALENDAR_TITLE_TEMPLATE = "客戶預約｜{姓名} {電話}";
...
export const CALENDAR_TITLE_TOKENS: ReadonlyArray<{ token: string; desc: string; sample: string }> = [
  { token: "{姓名}", desc: "預約人姓名", sample: "陳大明" },
